...
class Mesh {
    /**
        ...
        @param [staticDynamicDraw] either gl.STATIC_DRAW or gl.DYNAMIC_DRAW, depending how often the vertices will change
    */
    constructor(
        gl, 
        vertices, 
    ...
    )
    {
        ...
        if (vertices.length % elementsPerVertex != 0) {
            Debug.Error("Mesh Constructor: vert length, elem per vert mismatch: " +
                vertices.length + " " + elementsPerVertex);
        }
