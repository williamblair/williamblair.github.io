var Fungi = (function(){
	...
	*/
	...
	class FBO {
		...
		static delete(fbo) {
			// TODO - delete using cache name then delete from cache
	...
	var Renderer = (function(){
		...
		var f = function(ary){
			for(var i=0; i < ary.length; i++){
				...
				// render call back function after item has been rendered
