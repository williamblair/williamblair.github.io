/* Try number 3 using pthreads 
 * works, performance boost compared to previous
 * attempt since we wait until all threes in section
 * have been found before acessing the global count
 *
 * compile with:
 * gcc count3s_parallel3.c -o count3s_parallel3 -pthread 
 * 
 * */
#include <stdio.h>
#include <stdlib.h>
